...
class Gproxy:
    ...
    def settogdb(self, data):
        ...
        if s[3] != "":
            memstack = s[3].split("\n")
            GLOBAL.gdb_memstack = memstack
            SIGNALS.gdb_updated_stacks.emit()
    ...
    def settofrida_enum(self, data, type):
        ...
        elif type == "stalker-ct-module":
            GLOBAL.frida_stalkers_ct_module = data
            SIGNALS.frida_stalker_ct_module.emit()
